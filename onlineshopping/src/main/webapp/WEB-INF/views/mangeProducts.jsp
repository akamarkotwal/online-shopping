...
<c:if test="${not empty message}">	
		...
		<div class="col-md-offset-2 col-md-8">
			...
			<div class="panel panel-primary">
				...
				<!-- FORM ELEMENT -->
				<sf:form id="categoryForm" class="form-horizontal" modelAttribute="product"
				...
				<div class="form-group">
				<label class="control-label col-md-4"for="unitPrice">Enter Quantity Available</label>
				<div class="col-md-8">
	    ...
	    <div class="modal-content">
	      ...
	      <div class="form-group">
       			...
       			<div class="form-group">				
					...
					<div class="col-md-8 ">
						<sf:textarea cols="" row="5" path="descrption" id="category_description" class="form-control"
				...
				<div class="form-group">				
					<div class="col-md-offset-4 col-md-4">					
						<input type="submit" name="Add Category" value="Save" class="btn btn-primary"/>						
					</div>
				</div>	        
